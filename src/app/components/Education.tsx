...
const education = [
  {
    ...
    icon: Briefcase,
    description:
      "Working on alert triage models, clustering, anomaly detection, and agentic workflow experimentation to improve security operations.",
    achievements: [
      "Modeling for alert triage and prioritization",
      "Agentic workflow experiments for faster analysis",
      "Clustering + anomaly detection for security insights",
    ],
  },
  {
    ...
    location: "Belfast, Northern Ireland",
    period: "Sep 2023 - Present (Placement Year)",
    gpa: "In progress",
    icon: GraduationCap,
